  ...
  return (
    <footer className="relative z-10 bg-[#0D1B2A] text-gray-300">
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 md:px-14 lg:px-24">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="mb-4 flex items-center gap-2.5">
              <Picture src="/images/logo.jpg" alt="Herb-Era" className="h-8 w-auto rounded" />
            ...
            <div className="mt-5 flex items-center gap-3">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="flex h-11 w-11 items-center justify-center rounded-full bg-white/10 text-gray-400 transition hover:bg-pink-600 hover:text-white hover:scale-110" aria-label={t("footer.instagram")}>
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="flex h-11 w-11 items-center justify-center rounded-full bg-white/10 text-gray-400 transition hover:bg-blue-600 hover:text-white hover:scale-110" aria-label={t("footer.facebook")}>
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="flex h-11 w-11 items-center justify-center rounded-full bg-white/10 text-gray-400 transition hover:bg-sky-600 hover:text-white hover:scale-110" aria-label={t("footer.twitter")}>
                <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className="flex h-11 w-11 items-center justify-center rounded-full bg-white/10 text-gray-400 transition hover:bg-red-600 hover:text-white hover:scale-110" aria-label={t("footer.pinterest")}>
        ...
        <div className="mt-12 border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
